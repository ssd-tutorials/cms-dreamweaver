...
<div id="wr">
  <div id="cnt"><!-- InstanceBeginEditable name="tmp_edit_title" -->
    ...
    <p>Are you sure you want to remove this page?<br />
      There is no undo - all content will be removed permanently.</p>
      <p><a href="pages_remove.php?id=<?php echo $pid; ?>">Yes</a> | <a href="pages_list.php">No</a></p>
    <!-- InstanceEndEditable -->
    <div id="ft">
